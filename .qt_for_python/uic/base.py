...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.confirm_panel = QtWidgets.QWidget(self.form)
        self.confirm_panel.setObjectName("confirm_panel")
        self.horizontalLayout_3 = QtWidgets.QHBoxLayout(self.confirm_panel)
        self.horizontalLayout_3.setObjectName("horizontalLayout_3")
        self.aceptar = QtWidgets.QPushButton(self.confirm_panel)
        self.aceptar.setObjectName("aceptar")
        self.horizontalLayout_3.addWidget(self.aceptar)
        self.cancelar = QtWidgets.QPushButton(self.confirm_panel)
        self.cancelar.setObjectName("cancelar")
        self.horizontalLayout_3.addWidget(self.cancelar)
        self.formLayout.setWidget(8, QtWidgets.QFormLayout.SpanningRole, self.confirm_panel)
